...
[![Go Version](https://badge.fury.io/rb/colorls.svg)](https://badge.fury.io/rb/colorls)
[![Build Status](https://travis-ci.org/athityakumar/colorls.svg?branch=master)](https://travis-ci.org/athityakumar/colorls)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=shields)](http://makeapullrequest.com)

A Go cli that that requests the status of a website from the openduty.com website. 
...
The MIT License (MIT) 2021 - [sysrex](https://github.com/sysrex/). Please have a look at the [LICENSE.md](LICENSE.md) for more details.